...
export const progressFormFields = [
  ...
  },
  {
    ...
    label: 'Self Gen Inspections',
    type: 'select',
    required: true,
    tooltip: 'Enter number of self gen inspections that were on your schedule today.',
    category: 'Effort and Outcome',
    gridSpan: 24,
    placeholder: 'How many self gen inspections were on your schedule today?',
