...
const QuestionnaireForm: React.FC<IProps> = ({
    ...
    return (
        <div className="questionnaire-form mx-auto p-4 p-sm-5 border rounded shadow-sm ">
            ...
            <p className="mb-4">
                Before scheduling your one-on-one interview, we kindly ask you to answer a couple of quick questions to help
                us understand your availability and fit for the role. It’ll only take a moment!
            </p>
            {questions.map(({ label, name }, index) => (
                <div className="mb-4" key={index}>
                    ...
                    <div className="form-check mb-2">
                        ...
                        />
                        <label htmlFor={name+"Yes"} className="form-check-label">Yes</label>
                    </div>
