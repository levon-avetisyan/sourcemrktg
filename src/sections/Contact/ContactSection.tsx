      ...
      <address>
        <p className="text-center">
          ...
          <div className="d-flex">
            <i className="bi bi-telephone me-2"></i> <a href="tel:+12125551234">+1 212-555-1234</a><br />
            <i className="bi bi-envelope ms-3 me-2"></i> <a href="mailto:ny-office@example.com">ny-office@example.com</a>
          </div>
        </p>
      </address>
